...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="BeenTogether",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC12BeenTogether11AppDelegate")
...
SWIFT_CLASS("_TtC12BeenTogether19FirstViewController")
@interface FirstViewController : UIViewController
@property (nonatomic, weak) IBOutlet UILabel * _Null_unspecified getDayLabel;
@property (nonatomic, weak) IBOutlet UIDatePicker * _Null_unspecified datePicker;
- (void)viewDidLoad;
- (IBAction)datePickerChanged:(id _Nonnull)sender;
- (IBAction)handelGetStartedButton:(id _Nonnull)sender;
- (nonnull instancetype)initWithNibName:(NSString * _Nullable)nibNameOrNil bundle:(NSBundle * _Nullable)nibBundleOrNil OBJC_DESIGNATED_INITIALIZER;
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)coder OBJC_DESIGNATED_INITIALIZER;
@end


SWIFT_CLASS("_TtC12BeenTogether23HeaderInfoTableViewCell")
...
SWIFT_CLASS("_TtC12BeenTogether17InfoTableViewCell")
...
SWIFT_CLASS("_TtC12BeenTogether23MenuTableViewController")
...
SWIFT_CLASS("_TtC12BeenTogether13SceneDelegate")
...
SWIFT_CLASS("_TtC12BeenTogether20SecondViewController")
...
@property (nonatomic, weak) IBOutlet UILabel * _Null_unspecified daysLabel;
@property (nonatomic, weak) IBOutlet UIButton * _Null_unspecified titleBtn;
...
- (IBAction)handelMenuButton:(UIBarButtonItem * _Nonnull)sender;
- (IBAction)handelChangeBackgroundButton:(UIBarButtonItem * _Nonnull)sender;
- (IBAction)handelShareButton:(UIBarButtonItem * _Nonnull)sender;
- (IBAction)handelSettingButton:(UIBarButtonItem * _Nonnull)sender;
...
@interface SecondViewController (SWIFT_EXTENSION(BeenTogether)) <UIViewControllerTransitioningDelegate>
- (id <UIViewControllerAnimatedTransitioning> _Nullable)animationControllerForPresentedController:(UIViewController * _Nonnull)presented presentingController:(UIViewController * _Nonnull)presenting sourceController:(UIViewController * _Nonnull)source SWIFT_WARN_UNUSED_RESULT;
- (id <UIViewControllerAnimatedTransitioning> _Nullable)animationControllerForDismissedController:(UIViewController * _Nonnull)dismissed SWIFT_WARN_UNUSED_RESULT;
@end


SWIFT_CLASS("_TtC12BeenTogether26SettingTableViewController")
...
@interface SettingTableViewController (SWIFT_EXTENSION(BeenTogether)) <UITableViewDelegate>
...
@interface SettingTableViewController (SWIFT_EXTENSION(BeenTogether)) <UITableViewDataSource>
...
SWIFT_CLASS("_TtC12BeenTogether19SimpleTableViewCell")
...
SWIFT_CLASS("_TtC12BeenTogether17SlideInTransition")
...
SWIFT_CLASS("_TtC12BeenTogether19SwitchTableViewCell")
